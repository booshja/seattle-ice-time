...
import { type DrawerStore, createDrawerStore, initDrawerStore } from "./drawerStore";

export type DrawerStoreApi = ReturnType<typeof createDrawerStore>;

export const DrawerStoreContext = createContext<DrawerStoreApi | undefined>(undefined);
...
export const DrawerStoreProvider = ({ children }: DrawerStoreProviderProps) => {
    const storeRef = useRef<DrawerStoreApi>(null);
    if (!storeRef.current) {
